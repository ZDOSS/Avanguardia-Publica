...
class LoaderSenateRollCallTests(unittest.TestCase):
    def setUp(self):
        ...
        self.roll_call = {
            "source_record_key": "senate:119:2026:2",
            "congress": 119,
            "session": 2,
            "congress_year": 2026,
            "roll_call_number": 2,
        ...
        self.member_votes = [
            {
                "source_record_key": "senate:119:2026:2:S001",
                "lis_member_id": "S001",
                "bioguide_id": "A000001",
                "vote_cast": "yea",
            },
            {
                "source_record_key": "senate:119:2026:2:S002",
                "lis_member_id": "S002",
                "bioguide_id": "B000002",
                "vote_cast": "nay",
            },
    ...
    def test_atomic_senate_roll_call_rpc_counts_only_confirmed_rows(self):
        summary = _Summary()
        loader = self.loader_module.SupabaseLoader(None, None, summary=summary)
        loader.supabase = _Client()

        result = loader.upsert_senate_roll_call(self.roll_call, self.member_votes)
        ...
        self.assertEqual(1, summary.counts["senate_roll_calls_written"])
        self.assertEqual(2, summary.counts["senate_member_votes_written"])
    ...
    def test_database_gate_failure_propagates_without_write_counters(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "production writes are disabled"):
            loader.upsert_senate_roll_call(self.roll_call, self.member_votes)
    ...
    def test_transient_failure_replays_the_same_idempotent_rpc_payload(self):
        ...
        with patch.object(self.loader_module.time, "sleep") as sleep:
            result = loader.upsert_senate_roll_call(
                self.roll_call, self.member_votes
            )
